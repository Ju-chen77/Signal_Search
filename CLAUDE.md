...
个人研究项目。所有数据来自公开市场（Yahoo Finance、akshare、Google News RSS），不涉及任何非公开数据。

核心假设：**真正的范式公司（下一个亚马逊、下一个苹果）在成长过程中一定伴随巨大争议，这些争议会体现在股价的异常波动上。** 这个项目是一个"争议信号雷达"——用波动率作为第一个筛子，从公开市场中自动发现那些正在经历争议的公司，然后人工深入研究。
